...
app.post('/api/centers', authenticateToken, async (req, res) => {
...
// Update a  center
app.put('/api/centers/:id', authenticateToken, async (req, res) => {
    const { id } = req.params;
...
// Delete a  center
app.delete('/api/centers/:id', authenticateToken, async (req, res) => {
    const { id } = req.params;
